...
import com.myapp.MyAppOauthApp;
import com.myapp.ReactiveSqlTestContainerExtension;
import com.myapp.config.TestSecurityConfiguration;
...
@SpringBootTest(classes = { MyAppOauthApp.class, TestSecurityConfiguration.class })
